...
public class NarrativeInstanceTest {
    ...
    public void generateSampleGraph() {
        ...
        tempRoute.getProperties().putStringArrayList("Types", new ArrayList<String>(Arrays.asList("Mike")));
        ...
        tempRoute.setup();
        tempRoute.createProperties();
        tempRoute.getProperties().putStringArrayList("Types", new ArrayList<String>(Arrays.asList("Sam")));
        sampleRoutes.put(tempRoute.getId(), tempRoute);
        ...
        tempRoute.setup();
        tempRoute.createProperties();
        tempRoute.getProperties().putStringArrayList("Types", new ArrayList<String>(Arrays.asList("Sarah")));
        sampleRoutes.put(tempRoute.getId(), tempRoute);
        ...
        tempRoute.setup();
        tempRoute.createProperties();
        tempRoute.getProperties().putStringArrayList("Types", new ArrayList<String>(Arrays.asList("Chris")));
        sampleRoutes.put(tempRoute.getId(), tempRoute);
        ...
        tempRoute.setup();
        tempRoute.createProperties();
        tempRoute.getProperties().putStringArrayList("Types", new ArrayList<String>(Arrays.asList("Jessica")));
        sampleRoutes.put(tempRoute.getId(), tempRoute);
