...
/**
 * Here there are commented out traverse statements. One can uncomment them to see the structure of the graph.
 * 
 * @author rjm232
 * @author tj393
 *
...
public class GUINarrativeTest { // TODO add actual GUINarrative tests
    ...
    /**
     * Builds graph structure. Uncomment the traverse statement in addRouteAndNodeTest to see the structure.
     * 
     * <pre>
     * ________________
     * _____start______
