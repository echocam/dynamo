...
public class GUINarrativeTest { // TODO add actual GUINarrative tests
    ...
    public void renameRouteTest() {
        ...
        assertTrue("Check link4 renamed in start Node", gNarr.nodes.get("left").getExiting().contains(gNarr.routes.get("fromLeftToEnd")));
        assertTrue("Check link4 renamed in end Node",  gNarr.nodes.get("end").getEntering().contains(gNarr.routes.get("fromLeftToEnd")));
        //traverse(gNarr.start);
    }
    ...
    public void newRouteTest() throws NonUniqueIdException, GraphElementNotFoundException {
    	...
    	assertTrue("Check node being exited has correct name reference", gNarr.getNode("left").getExiting().contains(gNarr.routes.get("newLink4")));
    	assertTrue("Check node being entered has correct name reference", gNarr.getNode("end").getEntering().contains(gNarr.getRoute("newLink4")));
    ...
    public void insertChoiceOnRoute1Test() throws NonUniqueIdException, GraphElementNotFoundException {
    	...
    	assertEquals("Check newChoice has link2 entering", "link2", gNarr.getNode("newChoice").getEntering().get(0).getId());
    	assertEquals("Check newChoice has newLink exiting", "newLink", gNarr.getNode("newChoice").getExiting().get(0).getId());
    	...
    	assertTrue("Check end has newLink entering", gNarr.nodes.get("left").getEntering().contains(gNarr.routes.get("newLink")));
    ...
    public void insertChoiceOnRoute2Test() throws NonUniqueIdException, GraphElementNotFoundException {
    	...
    	assertEquals("Check newChoice has link5.1 entering", "link5.1", gNarr.getNode("newChoice").getEntering().get(0).getId());
    	assertEquals("Check newChoice has link5.2 exiting", "link5.2", gNarr.getNode("newChoice").getExiting().get(0).getId());
    	...
    	assertTrue("Check end has link5.2 entering", gNarr.getNode("end").getEntering().contains(gNarr.routes.get("link5.2")));
    	//traverse(gNarr.start);
    }
