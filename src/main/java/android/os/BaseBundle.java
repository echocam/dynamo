...
/*
 * Compiler warns about three instances of unchecked casts, but all are surrounded by
...
public class BaseBundle implements Serializable {
    ...
    /**
     * Returns the value associated with the given key, or false if no mapping of the desired type exists for the given
     * key.
     *
     * @param key
     *            a String
    ...
    /**
     * Returns the value associated with the given key, or defaultValue if no mapping of the desired type exists for the
     * given key.
     *
     * @param key
     *            a String
    ...
    /**
     * Returns the value associated with the given key, or (byte) 0 if no mapping of the desired type exists for the
     * given key.
     *
     * @param key
     *            a String
    ...
    /**
     * Returns the value associated with the given key, or (char) 0 if no mapping of the desired type exists for the
     * given key.
     *
     * @param key
     *            a String
    ...
    /**
     * Returns the value associated with the given key, or (short) 0 if no mapping of the desired type exists for the
     * given key.
     *
     * @param key
     *            a String
    ...
    /**
     * Returns the value associated with the given key, or 0L if no mapping of the desired type exists for the given
     * key.
     *
     * @param key
     *            a String
    ...
    /**
     * Returns the value associated with the given key, or 0.0f if no mapping of the desired type exists for the given
     * key.
     *
     * @param key
     *            a String
    ...
    /**
     * Returns the value associated with the given key, or 0.0 if no mapping of the desired type exists for the given
     * key.
     *
     * @param key
     *            a String
    ...
    /**
     * Returns the value associated with the given key, or null if no mapping of the desired type exists for the given
     * key or a null value is explicitly associated with the key.
     *
     * @param key
     *            a String, or null
    ...
    /**
     * Returns the value associated with the given key, or defaultValue if no mapping of the desired type exists for the
     * given key or if a null value is explicitly associated with the given key.
     *
     * @param key
     *            a String, or null
     * @param defaultValue
     *            Value to return if key does not exist or if a null value is associated with the given key.
     * @return the String value associated with the given key, or defaultValue if no valid String object is currently
     *         mapped to that key.
     */
     ...
     * @param defaultValue
     *            Value to return if key does not exist or if a null value is associated with the given key.
     * @return the CharSequence value associated with the given key, or defaultValue if no valid CharSequence object is
